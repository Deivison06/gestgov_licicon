    ...
    public function rules(): array
    {
        return [
            ...
            'regularidade_fiscal_trabalhista' => [
                ...
                'string',
                Rule::when(
                    in_array($this->input('tipo_contrato'), ['compras', 'servicos'], true),
                    ['in:Sim,Não']
                ),
            ],
            'comunicacao_atendimento' => 'nullable|string',
            'irregularidade_observada' => 'nullable|string',
            'houve_ocorrencia' => 'nullable|boolean',
            ...
            'checklist_fiscalizacao' => 'nullable|array',
            'checklist_fiscalizacao.*' => 'boolean',

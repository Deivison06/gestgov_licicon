...
<body>
    ...
    <div>
        ...
        <p>
            ...
            VALOR: R$ {{ $processo->detalhe->valor_estimado }}
        ...
        <p style="text-align: justify; text-indent: 30px;">
            Aos XXXXX dias do mês de XXXXXX de dois mil e vinte e dois , reuniu-se a
            Comissão de Licitação, instituída pela Portaria nº XXXX/2025 de XXXX de janeiro de
            2025, para deliberar sobre a {!! strip_tags($processo->objeto) !!}, foi enviado a esta
            comissão de Contratação propostas de preços: (INSERIR TODAS AS EMPRESAS
            PARTICIPANTES, É O IDEAL QUE TENHA JUNTO AO SISTEMA UM CAMPO PARA
            INCLUSÃO DA INFORMAÇÕES) após análise e verificação dos preços propostos, a
            comissão julgou e decidiu em favor da empresa XXXXXXXXXXXXXXXXXXXXXXXXXXXXX, CNPJ:
            XXXXXXXXXXXXXXXXXXXXXXXXX, respaldado no Art. 75, inciso II, da Lei nº
        ...
        <p style="text-align: justify; text-indent: 30px;">
            ...
            Empresa XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX CNPJ:
            XXXXXXXXXXXXXXXXXXXXXXX, apresentado melhor proposta e preços compatíveis com os
        ...
        <p style="text-align: justify; text-indent: 30px;">
            ...
            XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX CNPJ: XXXXXXXXXXXX foi de
        ...
        <p style="text-align: justify; text-indent: 30px;">
            ...
            XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX CNPJ: XXXXXXXXXXXXXXXXXXXXXXX foi
            de R$ XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
        </p>
        <h4>IX – CONCLUSÃO</h4>
        <p style="text-align: justify; text-indent: 30px;">

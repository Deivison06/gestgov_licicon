...
<head>
    <meta charset="UTF-8">
    <title>ATO DE AUTORIZAÇÃO DE DISPENSA DE LICITAÇÃO - Processo {{ $processo->numero_processo ?? $processo->id }}</title>
    <style type="text/css">
        @font-face {
            font-family: 'Aptos';
        ...
        <table style="width:100%; border-collapse:collapse; font-size:10px;">
            ...
            <tr>
                ...
                <td style="border:1px solid #000; padding:6px;">
                    @foreach($vencedores as $vencedor) {{ $vencedor->razao_social }} - {{ $vencedor->cnpj }} @break @endforeach,
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="border:1px solid #000; padding:6px;">
                    R$ {{ number_format($vencedores->sum(function($vencedor) {

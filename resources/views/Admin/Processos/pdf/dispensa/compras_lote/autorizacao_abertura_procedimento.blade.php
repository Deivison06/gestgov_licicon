...
<head>
    <meta charset="UTF-8">
    <title>AUTORIZAÇÃO PARA ABERTURA DE PROCEDIMENTO DE DISPENSA DE LICITAÇÃO - Processo {{ $processo->numero_processo ?? $processo->id }}</title>
    <style type="text/css">
        @page {
            margin: 0;
            size: A4;
...
<body>
    ...
    <div id="cover-page">
        ...
        <div class="cover-title">
            AUTORIZAÇÃO PARA ABERTURA DE PROCEDIMENTO DE DISPENSA DE LICITAÇÃO
        </div>
    </div>
    ...
    <div id="autorizacao-abertura-procedimento">
        <p style="text-align: center; font-weight: bold; background-color: #c8d3da; border: 1px solid #607d8b; padding: 6px;">AUTORIZAÇÃO PARA ABERTURA DE PROCEDIMENTO DE DISPENSA DE LICITAÇÃO <br>

...
<body>
    ...
    @if(isset($processo->detalhe->is_oriundo_fracassado) && $processo->detalhe->is_oriundo_fracassado)
        ...
        <p style="text-indent: 30px; text-align: justify;">
            Os autos encontram-se instruídos com o Estudo Técnico Preliminar (ETP) original, o Termo de Referência originário, a Ata da sessão da licitação fracassada, a Declaração de Manutenção das Condições Editalícias, a pesquisa de preços de mercado atualizada, e os documentos de habilitação da empresa interessada.
        </p>
        <p style="text-indent: 30px; text-align: justify;">
        ...
        <p style="text-indent: 30px; text-align: justify;">
            No tocante à regularidade procedimental e à instrução dos autos (art. 72 da NLLC), verifica-se a presença do Termo de Referência originário, a estimativa atualizada demonstrando a vantajosidade do preço a ser contratado frente ao mercado, a comprovação da regularidade fiscal, trabalhista e qualificação da empresa selecionada, e a correspondente dotação orçamentária.
        </p>
        <p style="text-indent: 30px; text-align: justify;">
            Ademais, ressalta-se que a exigência de manutenção das condições editalícias não impõe à Administração a contratação pelo exato valor estimado na licitação frustrada. A nova pesquisa de preços, exigida pelo art. 72, inciso II, demonstra a razoabilidade do preço pactuado nesta dispensa, resguardando a economicidade.
        </p>
        <p style="text-indent: 30px; text-align: justify;">
            Ressalva-se que este parecer possui natureza eminentemente jurídica, não adentrando nos juízos de conveniência, oportunidade, ou nas questões de cunho estritamente técnico e econômico (como a exatidão das pesquisas de mercado e a precisão do ETP), sendo tais aspectos de responsabilidade exclusiva dos setores administrativos competentes.
        </p>

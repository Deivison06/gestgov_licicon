...
<body>
    ...
    <div>
        ...
        <p style="text-align: justify;">
            1.1 O objeto da presente licitação consiste {!! strip_tags($processo->objeto) !!}, na modalidade Dispensa de Licitação, nos moldes do {{ optional($detalhe ?? null)->is_oriundo_fracassado ? 'Art. 75, Inciso III, alínea "a", da Lei Federal nº 14.133/2021' : 'art. 75, II da Lei 14.133/2021' }}.
        </p>
        <p style="text-align: justify;">

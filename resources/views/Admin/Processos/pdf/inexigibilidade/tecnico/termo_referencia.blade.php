...
<body>
    ...
    <div>
       ...
       <p style="display: flex; align-items: center; font-weight: bold; ">
        ...
        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 13. DA RAZÃO E ESCOLHA DO CONTRATADO
        </p>
        <p style="text-align: justify;">
            13.1. {!! strip_tags($processo->detalhe->razao_escolha_contratado) !!}
        </p>

        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 14. DA JUSTIFICATIVA DOS PREÇOS:
        </p>
        <p style="text-align: justify;">
            14.1. No que diz respeito a JUSTIFICATIVA DE PREÇOS, em atendimento ao que
            ...
            similares.
            <br>
            14.2. O contratado(a) apresentou notas fiscais e extratos de contratos de outros entes
            públicos, onde notadamente é similar ao valor proposto.
            14.3. Sendo assim, declara-se que o preço praticado para a presente contratação é
        ...
        <p style="text-align: justify;">
            ...
            contratuais;
            <br>
            15.1.2. reparar, corrigir, remover, reconstruir ou substituir, às suas expensas, no total ou
            ...
            <br>
            15.1.3. arcar com a responsabilidade civil por todos e quaisquer danos materiais e morais
            ...
            <br>
            15.1.4. utilizar empregados habilitados e com conhecimentos básicos dos serviços a
            serem executados, de conformidade com as normas e determinações em
            <br>
            15.1.6. apresentar à CONTRATANTE, quando for o caso, a relação nominal dos
            ...
            <br>
            15.1.7. responsabilizar-se por todas as obrigações trabalhistas, sociais, previdenciárias,
            tributárias e as demais previstas na legislação específica;
            <br>
            15.1.8. instruir seus empregados quanto à necessidade de acatar as orientações da
            Administração, inclusive quanto ao cumprimento das Normas Internas, quando for o
            caso;
            <br>
            15.1.9. relatar à Prefeitura toda e qualquer irregularidade verificada no decorrer da
            prestação dos serviços;
            <br>
            15.1.10. não permitir a utilização de qualquer trabalho do menor de dezesseis anos,
            ...
            insalubre;
            <br>
            15.1.11. manter durante toda a vigência do contrato, em compatibilidade com as
            obrigações assumidas, todas as condições de habilitação e qualificação exigidas na
            contratação;
            <br>
            15.1.12. não transferir a terceiros, por qualquer forma, nem mesmo parcialmente, as
            ...
            <br>
            15.1.14. Vedar a utilização, na execução dos serviços, de empregado que seja familiar de
            agente público ocupante de cargo em comissão ou função de confiança no órgão
            Contratante.
            <br>
            15.1.15. Disponibilizar à Contratante os empregados devidamente uniformizados e
            identificados por meio de crachá, além de provê-los com os Equipamentos de Proteção
            Individual - EPI, quando for o caso;
            <br>
            15.1.16. Fornecer os uniformes a serem utilizados por seus empregados, conforme
            disposto neste Termo de Referência, sem repassar quaisquer custos a estes;
            <br>
            15.1.17. As empresas contratadas que sejam regidas pela Consolidação das Leis do
            Trabalho (CLT) deverão apresentar a seguinte documentação no primeiro mês de
            prestação dos serviços:
            <br>
            15.1.18. Substituir, no prazo de 02:00 (horas), em caso de eventual ausência, tais como
            ...
            <br>
            15.1.19. Responsabilizar-se pelo cumprimento das obrigações previstas em Acordo,
            ...
            <br>
            15.1.19.1. Não serão incluídas nas planilhas de custos e formação de preços as
            ...
            <br>
            15.1.20. Efetuar o pagamento dos salários dos empregados alocados na execução
            ...
            <br>
            15.2. Assegurar à CONTRATANTE:
            <br>
            15.2.1. O direito de propriedade intelectual dos produtos desenvolvidos, inclusive sobre
            ...
            <br>
            15.2.2. Os direitos autorais da solução, do projeto, de suas especificações técnicas, da
            ...
            <br>
            15.3. Os serviços serão executados pela CONTRATADA na forma descrita no Termo de
            Referência;
            <br>
            15.4. Os termos indicados na proposta vinculam a referida contratação;
        </p>

        {!! $processo->detalhe->obrigacoes_contratado_extras !!}

        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 16. OBRIGAÇÕES DA CONTRATANTE 
        </p>
        <p style="text-align: justify;">
            16.1. A CONTRATANTE obriga-se a:
            <br>
            16.1.1 Proporcionar todas as condições para que a CONTRATADA possa desempenhar
            seus serviços de acordo com as determinações do Contrato e do Termo de Referência;
            <br>
            16.1.2. Exigir o cumprimento de todas as obrigações assumidas pela CONTRATADA, de
            acordo com as cláusulas contratuais e os termos de sua proposta;
            <br>
            16.1.3. Exercer o acompanhamento e a fiscalização do objeto contratado, por servidor
            ...
            <br>
            16.1.4. Notificar a CONTRATADA por escrito da ocorrência de eventuais imperfeições no
            curso da execução dos serviços, fixando prazo para a sua correção;
            <br>
            16.1.5. Pagar à CONTRATADA o valor resultante do objeto contratado, na forma do
            contrato;
            <br>
            16.1.6. Efetuar as retenções tributárias devidas sobre o valor da Nota Fiscal/Fatura da
            ...
            <br>
            16.2.1. exercer o poder de mando sobre os empregados da Contratada, devendo
            ...
            apoio ao usuário;
            <br>
            16.2.2. direcionar a contratação de pessoas para trabalhar nas empresas Contratadas;
            <br>
            16.2.3. promover ou aceitar o desvio de funções dos trabalhadores da Contratada,
            ...
            <br>
            16.2.4. considerar os trabalhadores da Contratada como colaboradores eventuais do
            próprio órgão ou entidade responsável pela contratação, especial mente para efeito de
            concessão de diárias e passagens;
            <br>
            16.3. fiscalizar mensalmente, por amostragem, o cumprimento das obrigações
            trabalhistas, previdenciárias e para com o FGTS, especialmente:
            <br>
            16.3.1. A concessão de férias remuneradas e o pagamento do respectivo adicional, bem
            como de auxílio-transporte, auxílio-alimentação e auxílio-saúde, quando for devido;
            <br>
            16.3.2. O recolhimento das contribuições previdenciárias e do FGTS dos empregados
            que efetivamente participem da execução dos serviços contratados, a fim de verificar
            qualquer irregularidade:
            <br>
            16.3.3. O pagamento de obrigações trabalhistas e previdenciárias dos empregados
            dispensados até a data da extinção do contrato;
            <br>
            16.4. Analisar os termos de rescisão dos contratos de trabalho do pessoal empregado na
            ...
            <br>
            16.5. Fornecer por escrito às informações necessárias para a execução do objeto
            contratado;
            <br>
            16.6. Realizar avaliações periódicas da qualidade do objeto contratado, após seu
            recebimento;
            <br>
            16.7. Cientificar o órgão de representação judicial do município para adoção das medidas
            cabíveis quando do descumprimento das obrigações pela Contratada;
            <br>
            16.8. Arquivar, entre outros documentos, projetos, "as built", especificações técnicas,
            ...
            <br>
            16.9. Assegurar que o ambiente de trabalho, inclusive seus equipamentos e instalações,
            ...
            <br>
            16.10. Verificar, no ato do recebimento, se o objeto entregue corresponde exatamente à
            marca/modelo/serviço contratado.
        </p>
        {{ $processo->detalhe->obrigacoes_contratante_extras }}

        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 17. SUBCONTRATAÇÃO
        </p>
        <p style="text-align: justify;">
            17.1. Não será admitida a subcontratação total do objeto licitatório;
        </p>

        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 18. REAJUSTE
        </p>
        <p style="text-align: justify;">
            18.1 Os preços são fixos e irreajustáveis no prazo de um ano contado da data limite para
            a apresentação das propostas;
            <br>
            18.1.1 Dentro do prazo de vigência do contrato e mediante solicitação da contratada, os
            ...
            <br>
            18.3. No caso de atraso ou não divulgação do índice de reajustamento, o
            ...
            <br>
            18.4. Nas aferições finais, o índice utilizado para reajuste será, obrigatoriamente, o
            definitivo;
            <br>
            18.5. Caso o índice estabelecido para reajustamento venha a ser extinto ou de qualquer
            ...
            <br>
            18.6. Na ausência dê previsão legal quanto ao índice substituto, as partes elegerão novo
        ...
        <p style="display: flex; align-items: center; font-weight: bold; ">
            <img src="{{ public_path('icons/grafico.png') }}" width="20" style="margin-right: 10px;"> 19. DAS SANÇÕES:
        </p>
        <p style="text-align: justify;">
            19.1. Pela inexecução total ou parcial do objeto deste contrato, a Administração pode

...
<div>
    ...
    <p style="text-align: justify">
        Trata-se de um serviço de natureza singular, onde a competição seria
        inviável, devido ao grau de confiabilidade necessário para prestação dos
        serviços. Foi inserida documentação suficiente para confirmação da notória
        especialização, como atestados de capacidades técnicas, certificados de
        graduação e pós-graduação inerentes a área de atuação, bem como de
        cursos técnicos condizentes com o objeto da contratação, conforme o artigo
        74, inc. III, “c” da Lei Federal 14.133/2021, justifica-se a contratação direta
        através de inexigibilidade de licitação, uma vez que não há obrigatoriedade
        de realização de certame licitatório.
    </p>
    ...
    <p style="text-align: justify">
        Em análise aos presentes autos, observamos que a empresa a ser
        contratada é uma tradicional prestadora dos serviços objeto desta
        contratação, atuando com conduta exemplar em diversos municípios, sem
        nada que desabone a sua conduta. Isso, agregado a comprovada notória
        especialização da empresa e dos profissionais que a representam, bem
        como a situação regular de toda documentação pertinente a habilitação
        jurídica, fiscal e trabalhista, justificam sua escolha, tendo a empresa
        apresentado o menor preço global, bem como toda documentação
        pertinente, que comprova o preenchimento dos requisitos de habilitação e
        qualificação mínima, ou seja, documentos de habilitação jurídica,
        regularidade fiscais e trabalhistas, atendendo ao artigo 72, incisos V e Vi da
        Lei Federai 14.133/2021.
    </p>

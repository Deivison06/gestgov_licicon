...
<div id="requisito-necessario" style="margin-top: 20px;">
    ...
    <p style="text-align: justify;">
        Nos termos do art. 40, inciso V, alínea “b”, da Lei nº 14.133/2021, a Administração Pública deve avaliar a possibilidade de parcelamento do objeto, sempre que tecnicamente viável e economicamente vantajoso, visando ampliar a competitividade e proporcionar melhor aproveitamento dos recursos públicos.
    </p>
    <p style="text-align: justify; text-indent: 30px;">
        No caso específico de contratação envolvendo locação de imóvel, verifica-se que não há viabilidade técnica ou econômica para o parcelamento do objeto, uma vez que o bem a ser contratado possui características indivisíveis, relacionadas à sua estrutura física, localização e destinação específica para atendimento das necessidades da Administração Pública.
    </p>
    <p style="text-align: justify; text-indent: 30px;">
        A locação de imóvel consiste na disponibilização de um único bem imóvel com características previamente definidas, tais como localização estratégica, dimensão adequada, estrutura física compatível e condições de uso apropriadas para o funcionamento das atividades administrativas ou prestação de serviços públicos. Dessa forma, eventual parcelamento do objeto não se mostra aplicável, pois não há como dividir o imóvel em partes independentes sem comprometer sua funcionalidade, eficiência operacional e finalidade pública.
    </p>
    <p style="text-align: justify; text-indent: 30px;">
        Além disso, a divisão da contratação poderia gerar prejuízos à execução das atividades administrativas, aumento de custos operacionais, dificuldades logísticas e fragmentação dos serviços prestados à população, contrariando os princípios da eficiência, economicidade e interesse público.
    </p>
    <p style="text-align: justify; text-indent: 30px;">
        Diante do exposto, conclui-se que o objeto da contratação é indivisível, sendo tecnicamente inviável o parcelamento, motivo pelo qual a contratação deverá ocorrer de forma integral, garantindo a adequada prestação dos serviços públicos e o pleno atendimento das necessidades da Administração.
    </p>
</div>

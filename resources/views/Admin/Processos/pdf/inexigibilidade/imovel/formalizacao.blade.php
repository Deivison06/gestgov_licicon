...
<body>
    ...
    {{-- ====================================================================== --}}
    {{-- BLOCO 3: DECLARAÇÃO DE INDISPONIBILIDADE DE IMÓVEL PRÓPRIO --}}
    {{-- ====================================================================== --}}
    <div id="declaracao-imovel">
        ...
        <p style="text-indent: 30px; text-align: justify;">
            ...
            execução das atividades referentes ao objeto em epígrafe. <br>
            ...
            <ul>
                <li>
                    Inexistência de imóvel público com a localização adequada ao
                    atendimento das demandas da pasta;
                </li>
                <li>
                    Inexistência de imóvel municipal com dimensões, estrutura física,
                    instalações elétricas, hidráulicas e de acessibilidade compatíveis com o
                    funcionamento da unidade pretendida;
                </li>
                <li>
                    Inexistência de imóvel próprio livre, desocupado e regularizado para
                    uso imediato;
                </li>
                <li>
                    Identificação de que eventual adaptação de imóveis existentes
                    demandaria reformas estruturais que comprometeriam a
                    economicidade, razoabilidade e continuidade do serviço público.
                </li>
            </ul>
            <br>
    ...
    {{-- ====================================================================== --}}
    {{-- BLOCO 4: AUTORIZAÇÃO PARA ESTUDO TÉCNICO --}}
    {{-- ====================================================================== --}}

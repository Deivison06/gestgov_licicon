...
<div>
    ...
    <p style="text-align: justify">
        A contratação em questão refere-se à prestação de serviço artístico, cuja
        natureza é personalíssima, demandando a atuação de profissional do setor
        artístico consagrado pela crítica especializada ou pela opinião pública,
        conforme previsto no art. 74, inciso II, da Lei nº 14.133/2021.
        Trata-se de hipótese de inexigibilidade de licitação motivada pela
        inviabilidade de competição, uma vez que o objeto da contratação está
        diretamente vinculado à pessoa do artista, sendo insubstituível e
        inconfundível, em razão de seu estilo, reconhecimento, originalidade e
        aceitação junto ao público-alvo.
        A consagração pela crítica especializada e/ou pela opinião pública está
        devidamente comprovada nos autos, por meio de apresentações anteriores
        realizadas em eventos relevantes, reconhecimento público e artístico,
        demonstrado por meio de prêmios, reportagens, materiais promocionais e
        menções em mídias especializadas e representação exclusiva, conforme
    ...
    <p style="text-align: justify">
        Em análise aos presentes autos, verifica-se que o(a) artista/banda é
        profissional consagrado(a) no setor artístico, com ampla aceitação pela
        opinião pública e reconhecimento por parte da crítica especializada,
        conforme demonstram os documentos anexados aos autos, tais como
        registros de apresentações relevantes, matérias jornalísticas, premiações e
        declarações de empresário exclusivo.
        Trata-se de profissional cuja contratação está amparada no art. 74, inciso II,
        da Lei nº 14.133/2021, o qual prevê a inexigibilidade de licitação quando
        inviável a competição, especialmente para a contratação de profissional do
        setor artístico, diretamente ou por meio de empresário exclusivo, desde que
        consagrado pela crítica especializada ou pela opinião pública.
        O contratado(a) apresentou ainda toda a documentação exigida quanto à
        habilitação jurídica, regularidade fiscal e trabalhista, demonstrando atender
        aos requisitos legais para a celebração do ajuste.
        Assim, justifica-se a escolha do(a) contratado(a), considerando a
        singularidade do serviço artístico, a inviabilidade de competição, a
        consagração pública e/ou crítica do profissional, e a adequação da proposta
        apresentada, o que torna a contratação legítima e regular à luz do

...
<body>
    ...
    @if (in_array('merenda_escolar', $clausulasEspeciais ?? []))
    <p>
        9.28. O prazo do fornecimento será imediatamente após apresentação da ordem de fornecimento, em conformidade
        com este Termo de Referência e a emissão da Ordem de Fornecimento emitida pelo órgão demandante.<br>
        9.29. O fornecimento ocorrerá conforme a necessidade da Secretaria demandante.<br>
        9.30. Os itens deverão ser entregues diretamente nas escolas, conforme os pedidos.<br>
        9.31. As entregas correrão de forma semanal.<br>
        9.32. As entregas de carnes e frios deverão ser feitas em veículos refrigerados objetivando a entrega adequada
        dos itens, os demais itens deverão ser transportados em caminhão tipo baú específico para esse fim, devendo
        ser previamente higienizados e não conter qualquer substância que possa acarretar lesão física, química ou
        biológica aos alimentos.<br>
        9.33. O recebimento do objeto não exclui a responsabilidade da contratada pelos prejuízos resultantes da
        incorreta execução do contrato.<br>
        9.34. No caso de produtos perecíveis, o prazo de validade na data da entrega não poderá ser inferior a 30
        (trinta) dias do prazo total recomendado pelo fabricante.<br>
        9.35. Os gêneros deverão estar sobrepostos em pallets e/ou em caixa de polietileno higienizadas quando
        necessário, não sendo permitido o transporte de hortifrútis em caixas de madeira ou papelão, com exceção dos
        ovos que poderão ser acondicionados em embalagem de papelão e/ou isopor, e/ou polietileno atóxico.<br>
        9.36. Os entregadores deverão estar devidamente identificados com o nome da empresa, uniformizados (camisa,
        sapato, calça, crachá, boné) com hábitos de higiene satisfatórios (uniforme limpos, higiene pessoal adequada)
        conforme boas práticas de fabricação/produção de alimentos possuindo boa conduta e relacionamento no local de
        entrega.
    </p>
    @endif

    @if (in_array('veiculos', $clausulasEspeciais ?? []))
    <p>
        9.37. O objeto deve ser entregue na sede da {{ strtoupper($prefeitura->nome) }}, localizada na
        {{ $prefeitura->endereco }}, no horário de 08h às 13h, ou em local indicado pela administração, o objeto deve
        ser entregue conforme Ordem de Fornecimento.<br>
        9.38. Para efeito de esclarecimento, a entrega do objeto deve ser feita utilizando caminhão plataforma do tipo
        reboque, guincho ou cegonha, devendo o Fiscal de Contrato proceder com a conferência do objeto no ato da
        entrega.<br>
        9.39. Antes da entrega do objeto, este não poderá sofrer deslocamento próprio (o veículo somente pode ser
        transportado em caminhão plataforma do tipo reboque), devendo ser entregue com quilometragem "zero" ou com a
        quilometragem registrada que seja decorrente de atividades de transporte ou de deslocamento no pátio da
        fábrica ou da própria empresa fornecedora.<br>
        9.40. Entregar, juntamente com os veículos, o manual, certificados de garantia do fabricante, notas fiscais e
        a relação da rede autorizada pelo fabricante;<br>
        9.41. Providenciar, independentemente de ser fabricante ou não fabricante, a correção ou substituição do todo
        ou em parte do material, peça, componente ou acessório, que apresente defeitos de fabricação ou divergência
        com as especificações estabelecidas no edital, sem ônus para administração, observando o contrato e a
        legislação vigente.
    </p>
    @endif

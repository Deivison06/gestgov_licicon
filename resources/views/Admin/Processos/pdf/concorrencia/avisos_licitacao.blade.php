...
<body>
    ...
    <div>
        ...
        <p style="text-align: justify; text-justify: inter-word; line-height: 1; margin: 0;">
            ...
            interessados que realizará procedimento licitatório na modalidade {{ $processo->modalidade->getDisplayName() }}, em

...
<body>
    ...
    <div>
        ...
        <p style="text-align: justify;">
            ...
            contados contados da ordem de Serviços, prorrogável na forma dos artigos 106 e 107 da Lei n° 14.133, de 2021. 
            <br><br>
        ...
        <div style="text-align: justify;">
            ...
            <div style="margin-left: 30px;">
                a) der causa à inexecução parcial do contrato;<br><br>
                b) der causa à inexecução parcial do contrato que cause grave dano à Administração ou ao funcionamento dos serviços públicos ou ao interesse coletivo;<br><br>
                c) der causa à inexecução total do contrato;<br><br>
                d) ensejar o retardamento da execução ou da entrega do objeto da contratação sem motivo justificado;<br><br>
                e) apresentar documentação falsa ou prestar declaração falsa durante a execução do contrato;<br><br>
                f) praticar ato fraudulento na execução do contrato;<br><br>
                g) comportar-se de modo inidôneo ou cometer fraude de qualquer natureza;<br><br>
                h) praticar ato lesivo previsto no art. 5º da Lei nº 12.846/2013.
            </div>

            <p>11.2. Serão aplicadas ao contratado que incorrer nas infrações acima descritas as seguintes sanções:</p>
            <div style="margin-left: 30px;">

...
<head>
    ...
    <style>
        ...
        /* Cards de Destinatários das Notificações */
        .card-destinatario {
            background-color: #f8fafc;
            border: 1px solid #cbd5e1;
...
<body>
    ...
    <script type="text/php">
        if (isset($pdf)) {
            ...
            @if(!$base64Timbre)
                $pdf->page_text(45, $yPosition, "GestGov Licicon — Relatório de Fiscalização | Emissão: " . date('d/m/Y H:i'), $font, $size, $color);
            @endif
        }
    </script>
            ...
            <tr>
                <td class="header-title-cell">
                    @if(!$base64Timbre)
                        ...
                        <div class="inst-sub">SISTEMA GESTGOV LICICON — MÓDULO DE FISCALIZAÇÃO CONTRATUAL (LEI Nº 14.133/2021)</div>
                    @else
                        <div class="inst-sub">GESTGOV LICICON — FISCALIZAÇÃO (LEI Nº 14.133/2021)</div>
                    @endif
                </td>
                <td class="doc-badge-cell">
                    @if(!$base64Timbre)
                        <div class="doc-type-badge">RELATÓRIO CONSOLIDADO</div>
                        <div class="doc-num">FISCALIZAÇÃO Nº {{ $fiscalizacao->numero_fiscalizacao }}</div>
                    @else
                        <div>
                            <span class="doc-type-badge">RELATÓRIO CONSOLIDADO</span>
    ...
    {{-- ================================================================= --}}
    {{-- PARTE 1: RELATÓRIO TÉCNICO DE FISCALIZAÇÃO                         --}}
    {{-- ================================================================= --}}
    <div class="main-title-container">
        ...
        <div class="main-subtitle">Acompanhamento formal e registros de fiscalização da execução do contrato</div>
    </div>
    ...
    <div class="legal-notice">
        ...
        A fiscalização contratual foi executada nos termos da <strong>Lei Federal nº 14.133/2021</strong> por meio de:
        <ul class="medidas-list">
            <li>Análise documental (notas fiscais, relatórios de execução, medições e comprovantes);</li>
            <li>Verificação presencial (vistorias <em>in loco</em>, registros fotográficos e contato com usuários);</li>
            <li>Reuniões e comunicações operacionais com representantes da empresa contratada;</li>
            <li>Alinhamento com as equipes operacionais da Secretaria requisitante.</li>
        </ul>
    </div>
    ...
    {{-- Relatório Fotográfico Integrante --}}
            ...
            @foreach($fiscalizacao->fotos as $foto)
                ...
                @if($fotoB64)
                    <div class="foto-card">
                        ...
                        <div class="foto-caption">{{ $foto->legenda ?? ('Registro Fotográfico de Vistoria ' . $loop->iteration) }}</div>
                    </div>
                @endif
            @endforeach
        </div>
    ...
    {{-- QUEBRA DE PÁGINA PARA AS NOTIFICAÇÕES --}}
    <div class="page-break"></div>

    {{-- ================================================================= --}}
    {{-- PARTE 2: RECOMENDAÇÕES AO GESTOR DO CONTRATO                     --}}
    {{-- ================================================================= --}}
    <div class="main-title-container">
    ...
    {{-- QUEBRA DE PÁGINA PARA NOTIFICAÇÃO À EMPRESA --}}
    <div class="page-break"></div>

    {{-- ================================================================= --}}
    {{-- PARTE 3: NOTIFICAÇÃO E RECOMENDAÇÕES À EMPRESA CONTRATADA        --}}
    {{-- ================================================================= --}}
    <div class="main-title-container">
